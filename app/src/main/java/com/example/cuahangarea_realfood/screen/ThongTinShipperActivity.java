...
public class ThongTinShipperActivity extends AppCompatActivity {
    ...
    private void LoadData() {
        ...
        firebase_manager.storageRef.child("Shipper").child(shipper.getiDShipper()).child("avatar").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                Glide.with(ThongTinShipperActivity.this)
                        .load(uri.toString())
    ...
    private void setEvent() {
        binding.txtGoToMaps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("oke","Oke");
                Toast.makeText(ThongTinShipperActivity.this, "oke", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ThongTinShipperActivity.this, MapsActivity.class);
        ...
        binding.btnEditAvatar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PickImageDialog.build(new PickSetup())
                        ...
                        .show(ThongTinShipperActivity.this);
            }
        });
        ...
        binding.btnNgaySinh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(ThongTinShipperActivity.this,
        ...
        binding.btnDangKy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (shipper == null) {
                    if (Validated_Form()) {
                        StorePassword storePassword = new StorePassword(ThongTinShipperActivity.this);
                        KAlertDialog kAlertDialog = new KAlertDialog(ThongTinShipperActivity.this, KAlertDialog.PROGRESS_TYPE).setContentText("Loading");
                        kAlertDialog.show();
        ...
        if (!validate.isBlank(binding.edtEmail) && validate.isEmail(binding.edtEmail)
            ...
            if (binding.edtNhapLaiMatKhau.getText().toString().equals(binding.edtMatKhau.getText().toString())) {
                ...
                if (CMND_sau == null || CMND_truoc == null) {
                    Alerter.create(ThongTinShipperActivity.this)
                            .setTitle("Lỗi")
